...
<section className="bg-white/5 backdrop-blur rounded-2xl p-8 shadow-lg border border-purple-500/20">
  ...
  <p className="text-gray-300 text-center mb-6">
    A selection of software, engineering, and design projects from coursework and personal interests.
  </p>
...
View on GitHub
    ...
    <div className="bg-black/30 rounded-xl p-6 border border-purple-500/20 flex flex-col">
      ...
      <p className="text-purple-400 text-xs mb-2">
  React • Flask • Python • SQLite
</p>
<p className="text-gray-400 text-sm mb-3 flex-grow">
Developed a full-stack recipe management application using React for the frontend and Flask with SQLite for the backend. Implemented features for creating, editing, deleting, searching, and categorizing recipes, along with dynamic recipe pages and a Recipe of the Day feature.</p>
<a
href="https://github.com/Oliviacbakke/cookbook"
target="_blank"
rel="noopener noreferrer"
className="inline-flex items-center gap-2 text-purple-300 hover:text-purple-400 text-sm font-medium"
>
